...
testEvalEnv = Env.fromList
    ...
    , ( "_&&" , fromJust (evalExpr (cLet "f" (cLam "#0" (cIf (cApp [cVar "@Integer.(==)", cVar "#0", cLit (TInteger 0)]) (cVar "zero") (cApp [cVar "succ", cApp [cVar "f", cApp [cVar "@Integer.(-)", cVar "#0", cLit (TInteger 1)]]]))) (cVar "f")) mempty) )
    ]
