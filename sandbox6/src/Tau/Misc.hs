...
data Prim
    ...
    | TNat     Integer                   -- ^ Natural numbers (Peano axiomatization)
...
deriving instance (Show t, Show u) => Show (Module t u)
deriving instance (Eq   t, Eq   u) => Eq   (Module t u)
deriving instance (Ord  t, Ord  u) => Ord  (Module t u)
