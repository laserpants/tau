...
runInfer :: ClassEnv f g -> TypeEnv -> StateT (Substitution, Context) (ReaderT (ClassEnv f g, TypeEnv) (SupplyT Name (ExceptT String Maybe))) a -> Either String (a, (Substitution, Context))
runInfer e1 e2 = 
