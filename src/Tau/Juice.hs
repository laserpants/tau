...
runPatternMatchCompilerT = flip evalSupplyT (freshNames ":") . unPatternMatchCompilerT
...
runInferK = flip evalSupplyT (freshNames "")
...
instantiate :: (MonadSupply Name m, MonadState [Class] m) => Scheme -> m Type
