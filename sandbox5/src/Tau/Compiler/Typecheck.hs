...
type InferState   = StateT (Substitution Type, Context)
...
runInferState :: (Monad m) => Context -> InferState m a -> m (a, (Substitution Type, Context))
