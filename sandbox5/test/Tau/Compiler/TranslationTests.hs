...
testCompileBundle = do
    ...
    let expr1 :: Stage1.TargetExpr (TypeInfoT [Error] (Maybe Type))
        expr1 = Fix (EApp (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TCon (Fix (KCon "*")) "String")), nodePredicates = []}) [Fix (EVar (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TArr (Fix (TCon (Fix (KCon "*")) "Symbol")) (Fix (TArr (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "*")) "String")))))), nodePredicates = []}) "@#getField"),Fix (ELit (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TCon (Fix (KCon "*")) "Symbol")), nodePredicates = []}) (TSymbol "c")),Fix (EApp (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))), nodePredicates = []}) [Fix (EVar (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TArr (Fix (TCon (Fix (KCon "*")) "Symbol")) (Fix (TArr (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "b" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))))))), nodePredicates = []}) "@#getField"),Fix (ELit (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TCon (Fix (KCon "*")) "Symbol")), nodePredicates = []}) (TSymbol "b")),Fix (EApp (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "b" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))))), nodePredicates = []}) [Fix (EVar (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TArr (Fix (TCon (Fix (KCon "*")) "Symbol")) (Fix (TArr (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "a" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "b" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "b" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))))))))), nodePredicates = []}) "@#getField"),Fix (ELit (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TCon (Fix (KCon "*")) "Symbol")), nodePredicates = []}) (TSymbol "a")),Fix (ECon (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "a" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "b" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))))), nodePredicates = []}) "#" [Fix (ECon (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TRow "a" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "b" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))), nodePredicates = []}) "{a}" [Fix (ECon (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "b" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))))), nodePredicates = []}) "#" [Fix (ECon (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TRow "b" (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))) (Fix (TCon (Fix (KCon "Row")) "{}")))), nodePredicates = []}) "{b}" [Fix (ECon (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TApp (Fix (KCon "*")) (Fix (TCon (Fix (KArr (Fix (KCon "Row")) (Fix (KCon "*")))) "#")) (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))))), nodePredicates = []}) "#" [Fix (ECon (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TRow "c" (Fix (TCon (Fix (KCon "*")) "String")) (Fix (TCon (Fix (KCon "Row")) "{}")))), nodePredicates = []}) "{c}" [Fix (ELit (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TCon (Fix (KCon "*")) "String")), nodePredicates = []}) (TString "d")),Fix (ECon (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TCon (Fix (KCon "Row")) "{}")), nodePredicates = []}) "{}" [])])]),Fix (ECon (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TCon (Fix (KCon "Row")) "{}")), nodePredicates = []}) "{}" [])])]),Fix (ECon (TypeInfo {nodeErrors = [], nodeType = Just (Fix (TCon (Fix (KCon "Row")) "{}")), nodePredicates = []}) "{}" [])])])])])])

    let coreExpr_ = Fix (CApp [Fix (CVar "@#getField"),Fix (CLit (TSymbol "c")),Fix (CApp [Fix (CVar "@#getField"),Fix (CLit (TSymbol "b")),Fix (CApp [Fix (CVar "@#getField"),Fix (CLit (TSymbol "a")),Fix (CApp [Fix (CVar "#"),Fix (CApp [Fix (CVar "{a}"),Fix (CApp [Fix (CVar "#"),Fix (CApp [Fix (CVar "{b}"),Fix (CApp [Fix (CVar "#"),Fix (CApp [Fix (CVar "{c}"),Fix (CLit (TString "d")),Fix (CVar "{}")])]),Fix (CVar "{}")])]),Fix (CVar "{}")])])])])])
    ...
    describe (prettyPrint expr) $ do
        ...
        it "✔ Core         : ... TODO ..." $ 
            Just coreExpr_ == (stageX6Expr bundle)
